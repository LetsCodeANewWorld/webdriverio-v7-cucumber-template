...
const cucumberJsonDir = 'tests/reports/cucumberjs-json-report/json/'
const cucumberReportFileMap = {}
const cucumberReportMap = {}
const jsonIndentLevel = 2
const htmlReportDir = 'tests/reports/cucumberjs-json-report/html/'
const screenshotsDir = 'tests/reports/cucumberjs-json-report/screenshots/'
...
function generateReport() {
  if (!fs.existsSync(cucumberJsonDir)) {
    ...
    report.generate({
      ...
      pageTitle: 'Webdriverio Html Report',
      reportName: `Webdriverio Html Report - ${new Date().toLocaleString()}`,
      metadata: {
        browser: {
          name: 'chrome'
        },
